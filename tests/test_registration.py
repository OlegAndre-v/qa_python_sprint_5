...
class TestUserRegistration:
    def test_registration_user(self, browser, login_page, registration_page):
        ...
        registration_page.fill_registration_form(user_data['name'], login, password)
    ...
    def test_incorrect_password_error(self, browser, registration_page):
        registration_page.open()
        registration_page.fill_registration_form(user_data['name'], generate_login(), generate_incorrect_password())
